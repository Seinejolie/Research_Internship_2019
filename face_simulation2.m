function [] = face_simulation2(observername,numface)
% path to the observer's directory
% num : face number (1-4)
emotions = ["sad", "happy"];
name = strcat(observername,"/calib12.edf")
calib = Edf2Mat(convertStringsToChars(strcat(observername,"/calib12.edf")));
...
[pupil1,pupil2,pupil3,pupil4] = PupilSize(edf0, 4999);
