...
num = 0;
observer = ["vincent","kenya"]
#obs = 'kanekosensei'
emotions =  ["anxious", "relax"]
n = 4;

list1 = [[0,1],[0,4],[0,5],[0,6],[1,2],[1,4],[1,5],[1,6],[1,7]]
#list2 = [[0,2],[0,3],[0,5],[0,6],[0,7],[1,1],[1,2],[1,4],[1,6],[1,7]]

list2 = [[0,2],[0,3],[0,6],[0,7],[1,1],[1,2],[1,4],[1,6],[1,7]]

shuffle(list1)
shuffle(list2)

f = open('vincent_2-1-1.txt', 'w')
